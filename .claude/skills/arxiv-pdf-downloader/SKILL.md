...
description: 根据 arXiv ID 或论文标题搜索并下载原始 PDF 到项目 00_Inbox/ 目录。用户说“下载 arxiv 论文”、“arxiv PDF”、“下论文”、“get arxiv paper”或任何希望把 arXiv 论文保存为 PDF 到 Inbox 时使用。
compatibility: 依赖 mcp__arxiv__search_papers / mcp__arxiv__get_abstract；使用 Python urllib 下载，无需额外包。
---
