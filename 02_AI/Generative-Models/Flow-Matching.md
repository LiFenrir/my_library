...
- [[02_AI/Generative-Models/Classifier-Free-Guidance|Classifier-Free Guidanc[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]] — 引导生成朝向条件样本
- [[01_Fundamentals/ML/diffusion-model|Diffusion Mode[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]] — 另一种基于分数匹配的生成方法
- [[04_Embodied-AI/VLA/Vision-Language-Action|Vision-Language-Actio[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]]|Vision-Language-Action Mode[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]] — 将 Flow Matching 用于动作生成的 VLA 框架
- [[04_Embodied-AI/VLA/Flow-based-VLA|Flow-based VL[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]] — 基于流匹配的 VLA 实例

## Papers

- [[05_Papers/articles/pi0-7|π0.[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]] — 使用 Flow Matching 动作专家生成 50 步动作块
...
- [[04_Embodied-AI/World-Model/world-action-model|World Action Mode[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]] — 使用 CFM 作为生成主干的机器人策略框架
- [[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]]|Causal Latent World Mode[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]] — 在语义空间中使用 CFM 的世界模型
...
- [[05_Papers/articles/pi0-7|π0.[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]] — 使用 Flow Matching 动作专家生成 50 步动作块
- [[05_Papers/articles/fast-wam|Fast-WAM: Do World Action Models Need Test-time Future Imagination[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]]
- Yaron Lipman et al., *Flow Matching for Generative Modeling*, arXiv:2210.02747

## 补充：来自 [[02_AI/Generative-Models/Flow-Matching|flow-matching（已合并[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]]
...
这种条件化框架支持从文本描述或种子图像灵活生成视频，是视频世界模型的基础训练目标（见 [[05_Papers/articles/causal-world-modeling|Causal World Modeling for Robot Contro[[04_Embodied-AI/World-Model/causal-world-model|Causal World Model]]）。
