...
- [[Flow-Matching|Flow Matching]] — CFG 可与其结合用于动作去噪
- [[04_Embodied-AI/VLA/Diverse-Prompting-for-VLA|Diverse Prompting for VLA]] — 在 VLA 中对多种提示组件应用 CFG
- [[01_Fundamentals/ML/diffusion-model|Diffusion Model]] — CFG 最初提出于扩散模型
- [[04_Embodied-AI/VLA/episode-metadata-prompting|Episode Metadata Prompting]] — π0.7 中对 metadata 使用 CFG 强化控制

## Papers

- [[05_Papers/articles/pi0-7|π0.7]] — 对 episode metadata 应用 CFG 以提升灵巧任务性能（第 VII 节）
